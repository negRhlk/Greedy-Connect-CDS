...
def detect_neighbor(node_source, NODE_RANGE, NUMBER_NODES, nodes, Gar):
    """
    In this function, the node's neighbors within a radius of a certain range are identified.
    The neighbors' nodes add to the network graph and neighbor array.
